...
1. An engineer writes a prompt describing intent or an ExecPlan in `docs/exec-plans/active/`
2. The agent implements, tests, and validates locally
3. The agent opens a PR with the ExecPlan updated to reflect decisions made
4. Agent reviewers (and optionally humans) review and merge
